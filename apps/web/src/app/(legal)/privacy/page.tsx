  ...
  return (
    <main className="min-h-screen bg-background">
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        <p className="mb-8 text-foreground leading-7">
        ...
        <h2 className="mt-12 mb-4 font-semibold text-3xl text-foreground tracking-tight">
          Interpretation and Definitions
        </h2>
        <h3 className="mt-8 mb-3 font-semibold text-2xl text-foreground">
          Interpretation
        </h3>
        <p className="mb-4 text-foreground leading-7">
        ...
        <ul className="mb-8 ml-6 list-disc space-y-4 text-foreground">
          <li>
          ...
          <li>
            <p className="leading-7">
              ...
              in this Agreement) refers to Belaern.
            </p>
          </li>
          <li>
            <p className="leading-7">
          ...
          <li>
            <p className="leading-7">
              <strong>Country</strong> refers to: Honduras
            </p>
          </li>
          <li>
            <p className="leading-7">
          ...
          <li>
            <p className="leading-7">
              <strong>Website</strong> refers to Belaern, accessible from{" "}
              <a
                href="https://belaern.com"
        ...
        <h4 className="mt-6 mb-3 font-semibold text-foreground text-xl">
          Personal Data
        </h4>
        <p className="mb-4 text-foreground leading-7">
        ...
        <ul className="mb-6 ml-6 list-disc space-y-2 text-foreground">
          <li>
            <p className="leading-7">Email address</p>
          </li>
          <li>
            <p className="leading-7">First name and last name</p>
          </li>
          <li>
            <p className="leading-7">Usage Data</p>
          </li>
        </ul>
        <h4 className="mt-6 mb-3 font-semibold text-foreground text-xl">
          Usage Data
        ...
        <ul className="mb-6 ml-6 list-disc space-y-4 text-foreground">
        ...
        <ul className="mb-8 ml-6 list-disc space-y-4 text-foreground">
          <li>
            ...
            <p className="leading-7">Type: Session Cookies</p>
            <p className="leading-7">Administered by: Us</p>
            <p className="leading-7">
          ...
          <li>
            ...
            <p className="leading-7">Type: Persistent Cookies</p>
            <p className="leading-7">Administered by: Us</p>
            <p className="leading-7">
        ...
        <ul className="mb-8 ml-6 list-disc space-y-2 text-foreground">
          <li className="leading-7">Comply with a legal obligation</li>
          <li className="leading-7">
          ...
          <li className="leading-7">Protect against legal liability</li>
        </ul>
        <h3 className="mt-8 mb-3 font-semibold text-2xl text-foreground">
        ...
        <ul className="mb-8 ml-6 list-disc space-y-2 text-foreground">
          <li>By email: info@belaern.com</li>
        </ul>
      </div>
    </main>
  );
